...
if not status_cmp then Schedudle_notify("Failed to load: " .. plugin_name_cmp, "error", { title = plugin_name_cmp }) return end

local plugin_name_lspkind = "lspkind"
local status_lspkind, plugin_lspkind = pcall(require, plugin_name_lspkind)
if not status_lspkind then Schedudle_notify("Failed to load: " .. plugin_name_lspkind, "error", { title = plugin_name_lspkind }) return end

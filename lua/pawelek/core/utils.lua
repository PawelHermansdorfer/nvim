...
Schedudle_notify = vim.schedule_wrap(function(msg, level, opts)
...
vim.api.nvim_create_user_command("Run", function()
    ...
    if data[lang] ~= nil and data[lang] ~= nil then
        ...
        Schedudle_notify("Run command not set for " .. lang, "error", { title = "Run" })
    end
end, {})
vim.api.nvim_create_user_command("Build", function()
    ...
    if data[lang] ~= nil and data[lang].build ~= nil then
        ...
        Schedudle_notify("Build command not set for " .. lang, "error", { title = "Build" })
    end
end, {})
